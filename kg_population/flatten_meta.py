...
def run():
    ...
    for repo in repos:
        ...
        original_json_path = join(unseen_original_json_path, repo)
        normalized_json_path = join(unseen_normalized_json_path, repo)
        final_json_path = join(unseen_final_json_path, repo)
        ...
        for filename in filenames:
            try:
                ...
                with open(join(normalized_json_path, filename + '_normalized.json'), 'r',
